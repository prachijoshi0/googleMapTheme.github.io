Custom Google Map Theme, customize by the user with the help of toggle button to chnage the theme of the map as well as the background.Done by using HTML, CSS and Javascript.
